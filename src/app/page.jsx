  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Enhance your AI prompts with Better Write Prompt. Get improved prompts for images, videos, avatars, and more. Make your AI generations better with optimized prompts." />
        <meta name="keywords" content="AI prompt, prompt enhancement, image generation, video generation, avatar creation, AI tools" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://better-write-prompt.vercel.app/" />
        <meta property="og:title" content="Better Write Prompt - AI Prompt Enhancement Tool" />
        <meta property="og:description" content="Enhance your AI prompts with Better Write Prompt. Get improved prompts for images, videos, avatars, and more. Make your AI generations better with optimized prompts." />
        <meta property="og:image" content="https://better-write-prompt.vercel.app/og-image.png" />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://better-write-prompt.vercel.app/" />
        <meta property="twitter:title" content="Better Write Prompt - AI Prompt Enhancement Tool" />
        <meta property="twitter:description" content="Enhance your AI prompts with Better Write Prompt. Get improved prompts for images, videos, avatars, and more. Make your AI generations better with optimized prompts." />
        <meta property="twitter:image" content="https://better-write-prompt.vercel.app/og-image.png" />

        {/* Additional SEO tags */}
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://better-write-prompt.vercel.app/" />
      </Head>
